...
# 🎨 Dark mode colors
DARK_BG = "#3B3535"       # window background
DISPLAY_BG = "#2d2d2d"    # display background
TEXT_COLOR = "#FFFFFF"    # main text color

DIGIT_BG = "#282626"      # number buttons
OPERATOR_BG = "#242222"   # operators (+, -, ×, ÷)
CLEAR_BG = "#00538B"      # dark red for "C"
SPECIAL_BG = "#444466"    # bluish-grey for x² and √x
EQUALS_BG = "#333399"     # deep blue for =
